...
// Users (current logged-in user defined in app state)
const USERS = [
...
Object.assign(window, {
  VEHICLES, VEHICLE_TYPES, FUEL_TYPES,
  USERS, DEPARTMENTS, PURPOSES, BOOKINGS, CHECKLIST, TODAY,
});
